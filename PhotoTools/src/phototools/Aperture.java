...
public class Aperture {
	...
	public double calculateAperture(int step) {
		return MathUtility.pow(2, (step * getStopMultiplier() * 0.5));
	}
	...
	public int hashCode() {
		...
		int result = 1;
		long temp;
		temp = Double.doubleToLongBits(stopMultiplier);
	...
	public boolean equals(Object obj) {
		...
		if (Double.doubleToLongBits(stopMultiplier) != Double
				.doubleToLongBits(other.stopMultiplier)) {
			return false;
		}
