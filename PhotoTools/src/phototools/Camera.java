...
public class Camera {
	 ...
	 * 
	 * @see Sensor sizes taken from
	 *      http://en.wikipedia.org/wiki/Image_sensor_format
	 *      #Table_of_sensor_sizes
	...
	public int hashCode() {
		...
		int result = 1;
		long temp;
		temp = Double.doubleToLongBits(circleOfConfusion);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(frameHeight);
		result = prime * result + (int) (temp ^ (temp >>> 32));
	...
	public boolean equals(Object obj) {
		...
		if (Double.doubleToLongBits(circleOfConfusion) != Double
				.doubleToLongBits(other.circleOfConfusion)) {
			return false;
		}

		if (Double.doubleToLongBits(frameHeight) != Double
				.doubleToLongBits(other.frameHeight)) {
			return false;
		}

		if (Double.doubleToLongBits(frameWidth) != Double
				.doubleToLongBits(other.frameWidth)) {
			return false;
		}
